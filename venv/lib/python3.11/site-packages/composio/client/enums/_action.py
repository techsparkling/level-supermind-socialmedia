...
class Action(_AnnotatedEnum[ActionData], path=ACTIONS_CACHE):
    ...
    NASA_RETRIEVE_AVAILABLE_PROJECT_IDS_UPDATED_SINCE_DATE: 'Action'
    NASA_RETRIEVE_ORGANIZATIONS_BY_NAME_FILTER: 'Action'
    NASA_RETRIEVE_ORGANIZATION_INFORMATION_BY_ID: 'Action'
    NASA_RETRIEVE_ORGANIZATION_TYPES_LIST: 'Action'
    NASA_RETRIEVE_PROJECT_DETAILS_BY_ID: 'Action'
    NASA_RETRIEVE_SWAGGER_SPECIFICATION_FOR_NASAAPI: 'Action'
    NASA_SEARCH_NASAPROJECTS_BY_CRITERIA: 'Action'
    ...
    @classmethod  # type: ignore
    @property
    @te.deprecated('Use NASA_RETRIEVE_ORGANIZATION_INFORMATION_BY_ID instead.')
    def NASA_ORGANIZATION_GET_INFORMATION(cls) -> 'Action':
        return cls.NASA_RETRIEVE_ORGANIZATION_INFORMATION_BY_ID

    @classmethod  # type: ignore
    @property
    @te.deprecated('Use NASA_RETRIEVE_ORGANIZATION_TYPES_LIST instead.')
    def NASA_ORGANIZATION_LIST_TYPES(cls) -> 'Action':
        return cls.NASA_RETRIEVE_ORGANIZATION_TYPES_LIST

    @classmethod  # type: ignore
    @property
    @te.deprecated('Use NASA_SEARCH_NASAPROJECTS_BY_CRITERIA instead.')
    def NASA_PROJECT_FIND_MATCHING_PROJECTS(cls) -> 'Action':
        return cls.NASA_SEARCH_NASAPROJECTS_BY_CRITERIA

    @classmethod  # type: ignore
    @property
    @te.deprecated('Use NASA_RETRIEVE_PROJECT_DETAILS_BY_ID instead.')
    def NASA_PROJECT_GET_INFO(cls) -> 'Action':
        return cls.NASA_RETRIEVE_PROJECT_DETAILS_BY_ID

    @classmethod  # type: ignore
    @property
    @te.deprecated('Use NASA_RETRIEVE_AVAILABLE_PROJECT_IDS_UPDATED_SINCE_DATE instead.')
    def NASA_PROJECT_LIST_AVAILABLE_IDS(cls) -> 'Action':
        return cls.NASA_RETRIEVE_AVAILABLE_PROJECT_IDS_UPDATED_SINCE_DATE

    @classmethod  # type: ignore
    @property
    @te.deprecated('Use NASA_RETRIEVE_SWAGGER_SPECIFICATION_FOR_NASAAPI instead.')
    def NASA_RESOURCE_GET_SPECIFICATION(cls) -> 'Action':
        return cls.NASA_RETRIEVE_SWAGGER_SPECIFICATION_FOR_NASAAPI
